      ...
      <div className={cn("max-w-[600px]", stores.editor.invalid && "invalid")}>
        ...
        >
          <div className="text-center p-10">
            <p className="text-2xl my-2 opacity-60">
              <Icon.ImagePlus className="mx-auto" size={36} />
            </p>
        ...
        {/* <div className="flex justify-between mt-2 py-4 px-6 rounded-md bg-white dark:bg-black shadow-sm">
          ...
          <Tooltip placement="top" arrow={false} title="Beautify Code">
            <Button
              ...
              type="default"
              size="large"
              icon={<Icon.CodeXml size={20} onClick={comingSoon} />}
            />
          </Tooltip>
          <Tooltip placement="top" arrow={false} title="Create gif animate">
            <Button
              ...
              type="default"
              size="large"
              icon={<Icon.ImagePlay size={20} onClick={comingSoon} />}
            />
          </Tooltip>
        </div> */}
        {/* <button
          className="w-full mt-1 rounded-md bg-white dark:bg-black border border-dotted dark:border-gray-700 shadow-sm flex justify-between items-center p-1 hover:bg-slate-50 dark:hover:bg-gray-900 hover:px-1.5"
          onClick={handleTry}
        >
          <div className="overflow-hidden rounded-sm w-8">
            <img src={demoPng} className="w-full" />
          </div>
          <div className="text-xs text-gray-500">Give it a try ✨</div>
        </button> */}
      </div>
    </div>
  );
